...
import (
	...
	"kitsa.ai/clinical-trial-parser/utils/common/col/set"
	"kitsa.ai/clinical-trial-parser/utils/common/util/slice"
	"kitsa.ai/clinical-trial-parser/utils/ct/criteria"
	"kitsa.ai/clinical-trial-parser/utils/ct/parser"
	"kitsa.ai/clinical-trial-parser/utils/ct/relation"
